...
namespace GameAnalyticsSDK.Net.Device
{
	...
	{
#if WINDOWS_UWP
        private const string _sdkWrapperVersion = "uwp 1.1.9";
#elif WINDOWS_WSA
        private const string _sdkWrapperVersion = "wsa 1.1.9";
#elif WINDOWS_PHONE
        private const string _sdkWrapperVersion = "wp8 1.1.9";
#else
        private const string _sdkWrapperVersion = "mono 1.1.9";
#endif
#if UNITY
